...
- Entscheidung vom 03.09.2026: Anfragen aus dem Kontaktformular gehen an lukas.sehorz@schconsult.de (app/content.ts, beim Hoster ueber ANFRAGE_EMPFAENGER uebersteuerbar). Der Versand laeuft ueber app/api/anfrage mit Resend, der Schluessel RESEND_API_KEY liegt nur beim Hoster (Vorlage .env.example). Ohne Schluessel oeffnet das Formular das E-Mail-Programm des Besuchers mit der fertigen Nachricht.
